    ...
    <nav className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          {/* Left side: Hospital Icon + Telemed */}
          ...
          <div className="hidden md:flex space-x-8 items-center">
            ...
            <Link to="/doctors" className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
            Doctors
            </Link>
            <Link to="/faqs" className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
            FAQs
            </Link>
            <Link to="/about-us" className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700">
            About Us
            </Link>
      ...
      {isOpen && (
        <div className="md:hidden" id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
            to="/"className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-indigo-600 hover:bg-gray-50"
